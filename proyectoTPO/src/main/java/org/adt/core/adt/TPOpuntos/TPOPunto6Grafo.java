...
public class TPOPunto6Grafo {
    ...
    public static void main(String[] args) {
        int i=0;
        int n=5; //n maximo es 100 por que en GraphPunto6, el MAX_NODES esta en 100, pero se puede cambiar
        grafoAleatorio = new GraphPunto6();
        addNodo(n);
        addArista(n);
        if(random==0){
            System.out.println("No se puede agregar una probabilidad que sea 0 (Cero)");
            }
            else {
